          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <DialogHeader className="space-y-2 mb-4">
              <DialogTitle className="text-xl">
                Join the Propaly Waiting List
              </DialogTitle>
              <DialogDescription>
                Get early access to a platform built to improve your
                credibility, capture high-quality leads, and automate your sales
                process.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="grid gap-3">
              ...
              <div className="grid gap-3">
                {/* <Label htmlFor="role">What do you want help with first?</Label> */}
                <select {...form.register("interest")} id="role" className="h-12 w-full rounded-md border border-input  px-3 text-sm">
                  <option value="">
                    What do you want help with first? (optional)
                  </option>
                  <option value="quality-leads">
                    Getting more quality leads
                  </option>
                  <option value="professional-credibility">
                    Looking more professional
                  </option>
                  <option value="property-management">
                    Managing property listings
                  </option>
                  <option value="automated-followup">
