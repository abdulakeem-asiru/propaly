  ...
  return (
    <div className='max-w-7xl bg-linear-180 from-[#FFC2A9] relative to-[#FF6347] h-100 rounded-3xl flex flex-col justify-center items-center mx-auto md:my-20 my-10 px-4' ref={fadeInUp}>
      <div className='flex flex-col gap-4 justify-center items-center'>
        ...
        <button className='backdrop-blur-2xl bg-linear-to-b from-[#FFC2A9] via-[#FF6347]/20 to-[#FFC2A9] inline-flex gap-2 md:text-lg   text-white font-medium border-y
         justify-center border-white rounded-full p-3 md:w-full lg:w-[calc(100%-200px)]  '>Get CRM Access <ArrowUpRight /></button>
