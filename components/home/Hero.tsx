  ...
  return (
    ...
    style={{ backgroundImage: `url(${HeroBg.src})` }}>
      <div className=" mt-20 flex flex-col gap-6 justify-center items-center px-4">
        <h1 className="font-semibold text-6xl max-w-[1000px] text-center leading-18 invisible" ref={splitTextRef}>Real Estate Made Effortless with Intelligent CRM Automation</h1>
